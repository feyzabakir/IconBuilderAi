...
namespace MextFullstackSaaS.Infrastructure.Services
{
    ...
    {
        private const string BucketName = "iconbuilderai-feyza";
        private readonly GoogleCredential _credential;

        public GoogleObjectStorageManager()
        {
            _credential = GoogleCredential.FromFile("C:\\Users\\Feyza\\OneDrive\\Masaüstü\\cosmic-decker-428219-n7-0ae645006a79.json");
        }
        public async Task<string> UploadImageAsync(string imageData, CancellationToken cancellationToken)
        {
            ...
            //return $"https://storage.googleapis.com/iconbuilderai-feyza/{fileName}";
            return fileName;
